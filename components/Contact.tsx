...
const Contact: React.FC<ContactProps> = ({}) => {
  return (
    <section className="bg-[#0A1011] ">
      <main className="px-6 py-4  m-auto text-white max-w-5xl">
        <SectionTitle title="Talk to Me" content="name : Jang Tae Hee" />
        <div className="w-full flex flex-col justify-center items-center ">
          <div className="flex items-center">
            ...
            <span className="text-yellow-300">jangth0655@gmail.com</span>
          </div>

          <div className="flex items-center space-x-2 my-2">
            <Link href={`https://github.com/jangth0655`}>
              <a className="text-yellow-300 flex space-x-2 items-center">
                <svg
                ...
                <span>https://github.com/jangth0655</span>
              </a>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-yellow-300">010 4185 0655</span>
          </div>
        </div>
      </main>
    </section>
